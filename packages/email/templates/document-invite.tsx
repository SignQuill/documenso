  ...
  return (
    <Html>
      ...
      <Body className="mx-auto my-auto bg-white font-sans">
        <Section>
          <Container className="mx-auto mb-2 mt-0 max-w-xl rounded-lg border border-solid border-slate-200 p-4 pt-0 backdrop-blur-sm">
            <Section>
              {branding.brandingEnabled && branding.brandingLogo ? (
                <Img src={branding.brandingLogo} alt="Branding Logo" className="mb-0 h-20" />
              ) : (
                <Img
                  src={getAssetUrl('/static/SignQuill_B2.png')}
                  alt="SignQuill Logo"
                  className="mb-0 h-20"
                />
              )}
